        ...
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            >
                <Link href="/about-page" className="flex items-center">
                    ...
                    <span className="mx-2">CHI SONO</span>
                </Link>
            </Typography>
            <Typography
                as="li"
            ...
            >
                <Link href={"/projects-page"} className="flex items-center">
                    ...
                    <span className="mx-2">PROGETTI</span>
                </Link>
            </Typography>
            <Typography
                as="li"
            ...
            >
                <Link href={"/draws-page"} className="flex items-center">
                    ...
                    <span className="mx-2">DISEGNI</span>
                </Link>
            </Typography>
            <Typography
                as="li"
        ...
        >
            <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
                <Typography className="mr-4 cursor-pointer py-1.5 font-medium flex rounded-lg px-2 items-center">
                    <img src={logo} width={50} alt="logo" className="me-2" />
                    Salvatore Pitanza W.D.
                </Typography>
