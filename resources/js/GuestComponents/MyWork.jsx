            ...
            <div className="container mx-auto">
                ...
                <div className="hidden  md:block mt-10 text-center ">
                    <div className={`gridc my-5 ${dark ? 'bg-black' : 'bg-white'}`}>
                        <div
                            className={`box one  ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
                            style={{ backgroundImage: `url(${img7})`}}
                            data-text="Clone Web App di Spotify"
                        ></div>
                        <div
                            className={`box two ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
                            style={{ backgroundImage: `url(${img5})` }}
                            data-text="Clone Dropbox"
                        ></div>
                        <div
                            className={`box three ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
                            style={{ backgroundImage: `url(${img6})` }}
                            data-text="Clone PlayStation"
                        ></div>
                        <div
                            className={`box four ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
                            style={{ backgroundImage: `url(${img3})` }}
                            data-text="Clone web App di WhatsApp Web"
                        ></div>

                        <div
                            className={`box five ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
                            style={{ backgroundImage: `url(${img4})` }}
                            data-text="Clone Discord"
                        ></div>
                        <div
                            className={`box six ${dark ? 'border border-gray-800' : 'border border-gray-200'}    rounded-3xl  `}
