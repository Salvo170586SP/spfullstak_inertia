...
export function Biography() {
    return (
        ...
        >
            <blockquote className="text-1xl md:text-4xl p-10 md:px-32 z-10 text-white font-bold ">
                <p>
                    'Viaggiare è camminare verso l'orizzontee, incontrare
                    l'altro, conoscere, scoprire e tornare più ricchi di quando
                    si era inizato il cammino'
                </p>
                <br />
