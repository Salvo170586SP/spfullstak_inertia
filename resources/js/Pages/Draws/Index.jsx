...
export default function Index({ auth, draws, pagination }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route("draws.store"), data, {
    ...
    const handleDelete = (id) => {
        router.delete(route("draws.destroy", id));
    };
                ...
                <div className="container mx-auto py-4">
                    <div className="flex">
                        <Button onClick={() => setOpenModal(true)}>
                            ...
                            <span className="ml-2">Aggiungi disegno</span>
                        </Button>
                        <Modal
                            show={openModal}
