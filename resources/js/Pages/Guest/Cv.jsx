                    ...
                    <div className="grid  sm:grid-rows md:grid-cols-3 mt-20 gap-5 align-center justify-center my-10">
                        {files.map((file, id) => {
                            return (
                                ...
                                >
                                    <figure className="relative hover:scale-110 transform-gpu transition">
                                        <img
                                            src={
                                        ...
                                        <a
                                            ...
                                            className="absolute bottom-10  text-white bg-opacity-80 bg-gray-800  shadow px-5 py-1 rounded-r-lg "
                                        >
                                            <small>
